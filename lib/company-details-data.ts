...
export const COMPANY_DATA: Record<string, CompanyDetail> = {
  ...
  sarr: {
    ...
    teamSize: "4명",
    website: "#",
    description: "사르르는 노인들이 병원 예약을 쉽게 할 수 있도록 도와주는 서비스를 개발한 SPEC 3기 프로젝트입니다.",
    founders: [
      { name: "김혜민", title: "팀원", linkedIn: "#" },
      { name: "류영상", title: "팀원", linkedIn: "#" },
      { name: "이유민", title: "팀원", linkedIn: "#" },
      { name: "이혜원", title: "팀원", linkedIn: "#" },
    ],
    jobs: [],
    news: [],
  },
  youth: {
    ...
    teamSize: "3명",
    website: "#",
    description: "유스는 개인 맞춤형 화장품과 미용용품 솔루션을 제공하는 SPEC 3기 프로젝트입니다. 서비스명: 스킨메이트.",
    founders: [
      { name: "권민재", title: "팀원", linkedIn: "#" },
      { name: "이연서", title: "팀원", linkedIn: "#" },
      { name: "최윤정", title: "팀원", linkedIn: "#" },
    ],
    jobs: [],
    news: [],
  },
  areum: {
    ...
    teamSize: "3명",
    website: "#",
    description: "아름은 공유 옷장 서비스를 진행한 SPEC 3기 프로젝트입니다.",
    founders: [
      { name: "김동인", title: "팀원", linkedIn: "#" },
      { name: "임영빈", title: "팀원", linkedIn: "#" },
      { name: "신지은", title: "팀원", linkedIn: "#" },
    ],
    jobs: [],
    news: [],
